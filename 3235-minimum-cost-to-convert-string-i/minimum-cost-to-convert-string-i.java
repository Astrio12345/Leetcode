class Solution {
    ...
    public long minimumCost(String source, String target, char[] original, char[] changed, int[] cost) {
        int[][] conversion = build(original, changed, cost);
        optimize(conversion);
        return compute(source, target, conversion);}
    private int[][] build(char[] original, char[] changed, int[] cost) {
        ...
        return graph;}
    private void optimize(int[][] graph) {
    ...
    private long compute(String source, String target, int[][] graph) {
        long totalCost = 0;
